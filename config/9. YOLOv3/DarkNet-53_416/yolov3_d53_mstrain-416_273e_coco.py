...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/YOLOv3/DarkNet-53_416'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/YOLOv3/DarkNet-53_416/epoch_136.pth'
workflow = [('train', 1)]
model = dict(
    type='YOLOV3',
