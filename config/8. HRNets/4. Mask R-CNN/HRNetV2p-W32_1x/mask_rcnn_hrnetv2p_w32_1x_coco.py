...
evaluation = dict(metric=['bbox', 'segm'], iou_thrs=[0.85])
...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Mask R-CNN/HRNetV2p-W32_1x'
