...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Cascade R-CNN/HRNetV2p-W32'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Cascade R-CNN/HRNetV2p-W32/epoch_20.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
