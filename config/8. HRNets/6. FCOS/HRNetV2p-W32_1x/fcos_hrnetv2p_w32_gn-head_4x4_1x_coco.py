...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/FCOS/HRNetV2p-W32_1x'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/FCOS/HRNetV2p-W32_1x/epoch_18.pth'
workflow = [('train', 1)]
model = dict(
    type='FCOS',
