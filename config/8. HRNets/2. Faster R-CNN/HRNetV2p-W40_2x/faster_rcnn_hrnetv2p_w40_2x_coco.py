...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Faster R-CNN/HRNetV2p-W40_2x'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Faster R-CNN/HRNetV2p-W40_2x/latest.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
