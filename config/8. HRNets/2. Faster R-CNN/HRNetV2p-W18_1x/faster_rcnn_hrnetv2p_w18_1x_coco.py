...
evaluation = dict(interval=1, metric='bbox', iou_thrs=[.50,0.95])
...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Faster R-CNN/HRNetV2p-W18_1x'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Faster R-CNN/HRNetV2p-W18_1x/epoch_7.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
