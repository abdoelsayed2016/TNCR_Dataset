...
evaluation = dict(metric=['bbox', 'segm'], iou_thrs=[0.5])
...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Hybrid Task Cascade (HTC)/HRNetV2p-W40'
