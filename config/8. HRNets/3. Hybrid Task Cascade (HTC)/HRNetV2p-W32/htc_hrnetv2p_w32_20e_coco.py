...
evaluation = dict(metric=['bbox', 'segm'], iou_thrs=[.50,0.95])
...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Hybrid Task Cascade (HTC)/HRNetV2p-W32'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/HRNets/Hybrid Task Cascade (HTC)/HRNetV2p-W32/epoch_8.pth'
workflow = [('train', 1)]
model = dict(
