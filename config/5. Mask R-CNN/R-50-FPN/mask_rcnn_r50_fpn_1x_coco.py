...
evaluation = dict(metric=['bbox', 'segm'],iou_thrs=[.50,.95])
...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/Faster R cnn/Different type loss/R-50-FPN_IoULoss'
