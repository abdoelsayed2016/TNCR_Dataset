...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/cascade_rpn/crpn_faster_rcnn_r50_caffe_fpn_1x_coco'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/cascade_rpn/crpn_faster_rcnn_r50_caffe_fpn_1x_coco/latest.pth'
workflow = [('train', 1)]
rpn_weight = 0.7
gpu_ids = range(0, 1)
