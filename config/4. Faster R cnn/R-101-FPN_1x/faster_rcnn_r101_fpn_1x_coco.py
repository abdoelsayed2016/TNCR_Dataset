...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/Faster R cnn/R-101-FPN_1x'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/Faster R cnn/R-101-FPN_1x/latest.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
