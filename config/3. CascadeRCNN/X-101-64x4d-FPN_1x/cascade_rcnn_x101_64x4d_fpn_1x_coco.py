...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/CascadeRCNN/X-101-64x4d-FPN_1x'
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/content/drive/MyDrive/ColabNotebooks/Table_work/output_mmdetection/CascadeRCNN/X-101-64x4d-FPN_1x/epoch_12.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
